...
class AnimationManager {
  ...
  drawTextWithOpenTypePath(context, textObject, props) {
    ...
    try {
      ...
      console.warn("Safari stylistic set playback fallback failed:", error);
      return false;
    }
  }
  ...
  renderTextObjectAtFrame(textObject, frame, context) {
    ...
    if (this.app.fontManager && this.app.fonts.has(textObject.fontFamily)) {
      this.renderTextWithFeatures(textObject, props, context, lineHeightPx);
    } else {
  ...
  renderTextWithFeatures(textObject, props, context, lineHeightPx) {
